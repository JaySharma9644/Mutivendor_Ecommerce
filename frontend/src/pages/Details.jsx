...
const Details = () => {
    ...
    const {totalReview} = useSelector(state => state.home)
                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        <div>
                            <div className='p-5 border'>
                                <img className='h-[400px] w-full' src={image ? image : product?.images?.length > 0 ? product?.images[0] : ''} alt="" />
                            </div>
                            <div className='py-3'>
                                {
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex gap-3 pb-10 border-b'>
                                {
                                    product?.stock ? <>
                                        <div className='flex bg-slate-200 h-[50px] justify-center items-center text-xl'>
                                            <div className='px-6 cursor-pointer' onClick={(e) => dec()} >-</div>
                                            <div className='px-6'>{quantity}</div>
                                            <div className='px-6 cursor-pointer' onClick={(e) => inc()}>+</div>
                                        </div>
                                        <div>
                                            <button onClick={(e) => add_cart()} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#059473] text-white'>Add To Card</button>
                                        </div>
                                ...
                                <div>
                                    <div onClick={(e) => add_wishlist()} className='h-[50px] w-[50px] flex justify-center items-center cursor-pointer hover:shadow-lg hover:shadow-cyan-500/40 bg-cyan-500 text-white'>
                                        <FaHeart />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='flex gap-3'>
                                {
                                    product?.stock>0 ? <button  onClick={(e)=>buyNow()}  className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#247462] text-white'>Buy Now</button> : ''
                                }
                                            ...
                                            return (
                                                <Link className='block' key={i}>
                                                    <div className='relative h-[270px]'>
                                                        <img className='w-full h-full' src={ product?.images?.length > 0 ? product?.images[0] : ''} alt="" />
                                                        {
                                                    ...
                                                    <div className='flex gap-2'>
                                                        <h2 className='text-lg font-bold text-slate-600'>$ {product?.price}</h2>
