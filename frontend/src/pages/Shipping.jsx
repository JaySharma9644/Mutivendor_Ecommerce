...

                                {
                                    products.map((p, i) => <div className='flex bg-white p-4 flex-col gap-2'>
                                        <div className='flex justify-start items-center'>
                                            <h2 className='text-md text-slate-600 font-bold'>{p?.name}</h2>
                                        </div>
                        ...
                        <div className='w-[33%] md-lg:w-full'>
                            <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                ...
                                <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <button disabled={res ? false : true} onClick={()=>placeOrder()} className={`px-5 py-[6px] rounded-sm hover:shadow-red-500/50 hover:shadow-lg ${res ? 'bg-red-500' : 'bg-red-300'}  text-sm text-white uppercase`}>
                                        Place Order
                                    </button>
