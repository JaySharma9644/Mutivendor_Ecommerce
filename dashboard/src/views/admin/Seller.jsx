        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{i}</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <img className='w-[45px] h-[45px]' src={seller?.image} alt="" />
                </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{seller.name}</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{seller?.shopInfo?.shopName}</td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <span>{seller.payment}</span> </td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{seller.email} </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{seller?.status} </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{seller?.shopInfo?.district} </td>
