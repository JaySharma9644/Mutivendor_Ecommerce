                ...
                <div className='w-full md:w-6/12'>
                    <div className='w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]'>
                        <div className='flex justify-center items-center py-3'>
                            ...
                            <input type="file" onChange={add_image}  className='hidden' id='img' />
                        </div>
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {
                                ...
                                <form onSubmit={addProfile}>
                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        ...
                                        <input onChange={inputHandler} value={state.shopName} className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='shopName' id='Shop' placeholder='Shop Name' />
                                    </div>

                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        <label htmlFor="division">Division Name</label>
                                        <input onChange={inputHandler} value={state.division}  className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='division' id='division' placeholder='division Name' />
                                    </div>

                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        <label htmlFor="district">District Name</label>
                                        <input onChange={inputHandler} value={state.district} className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='district' id='district' placeholder='District Name' />
                                    </div>

                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        <label htmlFor="subdis">Sub District Name</label>
                                        <input onChange={inputHandler} value={state.subDistrict} className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='subdis' id='subdis' placeholder='Sub District Name' />
                                    </div>
