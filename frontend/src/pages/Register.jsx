                            ...
                            <div>
                                <form className='text-slate-600' onSubmit={register}>
                                    ...
                                    <div className='flex flex-col gap-1 mb-2'>
                                        ...
                                        <input onChange={inputHandler} value={state.email} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' type="email" name="email" id="email" placeholder='Email' required />
                                    </div>
