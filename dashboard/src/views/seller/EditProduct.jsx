...
const EditProduct = () => {
    ...
    const { product, successMessage, loader, errorMessage } = useSelector(state => state.product)
                ...
                <div>
                    <form onSubmit={update}>
                        ...
                        <div className='grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 gap-3 w-full text-[#d0d2d6] mb-4'>
                            {
                                imageShow?.length > 0 && imageShow.map((img, i) => <div>
                                    <label htmlFor={i}>
                                        <img src={img} alt="" />
                                    </label>
                        ...
                        <div className='flex'>
                            <button disabled={loader ? true : false} className='bg-red-500  hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2 my-2'>
                                {
