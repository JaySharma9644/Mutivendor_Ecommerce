...
import { get_payment_request, payment_request_confirm,messageClear } from '../../store/Reducers/paymentReducer';
...
const PaymentRequest = () => {
    ...
    const confirm_request  = (paymentId) =>{

        setPaymentId(paymentId);
        dispatch(payment_request_confirm(paymentId));
    }
    useEffect(()=>{
