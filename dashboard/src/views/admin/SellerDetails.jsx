...
const SellerDetails = () => {
    ...
    const { successMessage, loader, errorMessage } = useSelector(state => state.seller)
                ...
                <div>
                    <form onSubmit={submit}>
                        <div className='flex gap-4 py-3'>
                            ...
                            <button disabled={loader ? true : false} className='bg-red-500 w-[170px] hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2'>
                            {
